...
void setup() {
  ...
  pinMode(ledC, OUTPUT);      // set the LEDB pin mode
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.print("<p style=\"font-size:7vw;\">  <a href=\"/H\">Turn ON</a> LED_ROOM<br></p>");
            client.print("<p style=\"font-size:7vw;\">  <a href=\"/L\">Turn OFF</a> LED_ROOM<br></p>");
            client.print("<p style=\"font-size:7vw;\">  <a href=\"/M\">Turn ON</a> LED_KITCHEN<br></p>");
            client.print("<p style=\"font-size:7vw;\">  <a href=\"/N\">Turn OFF</a> LED_KITCHEN<br></p>");
